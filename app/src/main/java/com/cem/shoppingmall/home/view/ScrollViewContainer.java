package com.cem.shoppingmall.home.view;

/**
 * Created by huangqigen on 2017/5/23.
 */
...
public class ScrollViewContainer extends RelativeLayout{
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        switch (ev.getActionMasked()){
            ...
            case MotionEvent.ACTION_POINTER_UP:
                //多只手指按下或者抬起时舍弃将要到来的第一个事件move，防止多点拖拽的bug
                mEvents=-1;
                break;

            case MotionEvent.ACTION_MOVE:
                vt.addMovement(ev);
                if(canPullDown&&mCurrentViewIndex==0&&mEvents==0){
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if(!isMeasured){
            ...
            Log.i("ScrollView","getMeasuredHeight()="+getMeasuredHeight());
            Log.i("ScrollView","getMeasuredWidth()="+getMeasuredWidth());
